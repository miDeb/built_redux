...
class _$CollectionActions extends CollectionActions {
  ...
  final builtListAction =
      VoidActionDispatcher('CollectionActions-builtListAction');
  final builtListMultimapAction =
      VoidActionDispatcher('CollectionActions-builtListMultimapAction');
  final builtMapAction =
      VoidActionDispatcher('CollectionActions-builtMapAction');
  final builtSetAction =
      VoidActionDispatcher('CollectionActions-builtSetAction');
  final builtSetMultimapAction =
      VoidActionDispatcher('CollectionActions-builtSetMultimapAction');
...
class CollectionActionsNames {
  static final builtListAction =
      ActionName<void>('CollectionActions-builtListAction');
  static final builtListMultimapAction =
      ActionName<void>('CollectionActions-builtListMultimapAction');
  static final builtMapAction =
      ActionName<void>('CollectionActions-builtMapAction');
  static final builtSetAction =
      ActionName<void>('CollectionActions-builtSetAction');
  static final builtSetMultimapAction =
      ActionName<void>('CollectionActions-builtSetMultimapAction');
}
